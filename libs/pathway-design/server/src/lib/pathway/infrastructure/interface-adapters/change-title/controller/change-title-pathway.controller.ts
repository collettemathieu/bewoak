...
export class ChangeTitlePathwayController {
    constructor(private readonly changeTitlePathwayService: ChangeTitlePathwayService) {}
    ...
    execute(
        ...
        return this.changeTitlePathwayService.execute(
            new ChangeTitlePathwayCommand(changeTitlePathwayRequestParamsDto.pathwayId, changeTitlePathwayRequestBodyDto.title)
        );
    }
}
